...
class Install
{
    ...
    {
        echo 'Gaia-form installation successful, please execute `php gaia vendor:publish gaia\form`' . PHP_EOL;
    }
    ...
    {
        echo 'Gaia-form upgrade successful, please execute `php gaia vendor:publish gaia\form`' . PHP_EOL;
    }
